...
class StructuredEventIngestor:
    ...
    def ingest(self, raw_event: Dict[str, Any]) -> IngestionResult:
        ...
        Automatically extracts assertions if raw_text exists but no assertions are provided
        """
        try:
    ...
    def bulk_ingest(self, raw_events: List[Dict[str, Any]]) -> List[IngestionResult]:
        ...
        Automatically extracts assertions for each event if needed
        """
        results = []
    ...
    def extract_assertions(
        ...
        """
        Public method to extract assertions without ingesting
        """
