        ...
        try:
            ...
            report = {
                ...
                "summary": {
                    ...
                    "avg_excess_return": float(outcome_row[2]) if outcome_row[2] is not None else 0.0,
                    "win_count": outcome_row[3] if outcome_row[3] is not None else 0,
                    "win_rate": (outcome_row[3] / outcome_row[0]) if outcome_row[0] and outcome_row[3] else 0.0,
                },
