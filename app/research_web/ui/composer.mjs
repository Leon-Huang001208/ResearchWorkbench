...
export function renderComposer({ page, draft, attachments = [], expectedFormats = null, skills = [], skillId = '', disabled = false, busy = false, taskPending = false, detail = null, slashOpen = false } = {}) {
