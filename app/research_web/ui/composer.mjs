...
export function renderComposer({ models = [], model = '', page, draft, attachments = [], tabbitTabs = [], tabbitCandidates = [], tabbitOpen = false, tabbitLoading = false, tabbitIndex = 0, expectedFormats = null, skills = [], skillId = '', capability = null, toolIds = [], tools = [], disabled = false, busy = false, taskPending = false, detail = null, slashOpen = false, slashIndex = 0, runtimeReady = true } = {}) {
  const claw = page === 'claw';
