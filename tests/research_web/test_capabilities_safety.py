...
@pytest.mark.parametrize(
    ...
    [
        ...
        "import multiprocessing as process_pool",
        "import multiprocessing.pool as worker_pool",
        "from multiprocessing import Process as Worker",
        "from multiprocessing.pool import Pool as WorkerPool",
        "import concurrent.futures as future_pool\nlaunch = future_pool.ProcessPoolExecutor",
        "import concurrent.futures\nlaunch = concurrent.futures.ProcessPoolExecutor",
        "from concurrent.futures import ProcessPoolExecutor as Pool\nlaunch = Pool",
        "from concurrent import futures as future_pool\nlaunch = future_pool.ProcessPoolExecutor",
        "import pty as pseudo_terminal\nlaunch = pseudo_terminal.fork",
        "from pty import fork as launch\ncopy = launch",
        "from os import *",
        "from pty import *",
        "from asyncio import *",
    ],
    ids=[
        ...
        "multiprocessing-module-alias",
        "multiprocessing-submodule-alias",
        "multiprocessing-process-from-import",
        "multiprocessing-pool-submodule-from-import",
        "process-pool-module-alias",
        "process-pool-dotted-module",
        "process-pool-from-import",
        "process-pool-from-concurrent",
        "pty-fork-alias",
        "pty-fork-from-import",
        "os-star-import",
        "pty-star-import",
        "asyncio-star-import",
    ],
...
@pytest.mark.parametrize(
    ...
    [
        ...
        "import concurrent.futures as future_pool\nexecutor = future_pool.ThreadPoolExecutor",
    ],
    ids=[
        "subprocess-shadow",
        "os-shadow",
