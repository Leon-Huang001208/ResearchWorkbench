...
def test_propagation_path_calculate_overall_strength():
    ...
    path.steps = [
        PropagationStep(node_id="n1", node_name="N1", impact="start", mapping_strength=0.9, symbol=None),
        PropagationStep(node_id="n2", node_name="N2", impact="test", mapping_strength=0.8, symbol="123"),
    ]
