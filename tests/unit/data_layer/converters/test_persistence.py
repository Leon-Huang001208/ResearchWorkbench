...
class TestPersistence:
    ...
    def test_sanitize_filename_normal(self):
        from data_layer.converters.persistence import _sanitize_filename
    ...
    def test_persist_markdown(self, tmp_path):
        ...
        with patch("data_layer.converters.persistence.settings", _make_settings(md_dir, raw_dir)):
    ...
    def test_should_inline_small(self):
        from data_layer.converters import persistence as pmod
    ...
    def test_should_inline_large(self):
        from data_layer.converters.persistence import should_inline
    ...
    def test_read_markdown_not_exists(self, tmp_path):
        from data_layer.converters.persistence import read_markdown
    ...
    def test_read_raw_text_not_exists(self, tmp_path):
        from data_layer.converters.persistence import read_raw_text
    ...
    def test_delete_outputs(self, tmp_path):
        from data_layer.converters.persistence import (
            delete_outputs,
            persist_markdown,
            persist_raw_text,
        )
        ...
        with patch("data_layer.converters.persistence.settings", test_settings):
    ...
    def test_output_path_uses_pdf_id(self, tmp_path):
        from data_layer.converters.persistence import _output_path
    ...
    def test_persist_creates_parent_dirs(self, tmp_path):
        ...
        with patch("data_layer.converters.persistence.settings", _make_settings(deep_dir, raw_dir)):
