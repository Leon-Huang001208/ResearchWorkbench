...
specified time window, serving as a structured evaluation supplement to
    ...
    entry_rule: Optional[str] = Field(default=None, description="Optional entry rule used (if applicable)")
    horizon: OutcomeHorizon = Field(default="20d", description="Outcome horizon (e.g., 20d)")
    benchmark: Optional[str] = Field(default=None, description="Optional benchmark used for excess return calculation")
    outcome_return: float = Field(default=0.0, description="Return of the outcome")
    outcome_excess_return: float = Field(default=0.0, description="Excess return over the benchmark")
    max_drawdown: float = Field(default=0.0, description="Maximum drawdown experienced")
    decay: float = Field(default=0.0, description="Decay score")
    failure_reason: Optional[str] = Field(default=None, description="Optional reason for failure (if applicable)")
    lesson: Optional[str] = Field(default=None, description="Optional lesson learned (if applicable)")
    evaluated_at: Optional[datetime] = Field(default=None, description="Timestamp when the outcome was evaluated (if applicable)")
    metadata: dict[str, str] = Field(default_factory=dict, description="Additional metadata as a dictionary of strings")
