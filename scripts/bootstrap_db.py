...
from data_layer.repositories.base import check_database_connection, engine, ensure_schema, get_db
...
def seed_defaults(db):
    ...
    logger.info(
        f"Seeding complete: inserted {inserted} new thresholds, updated {updated} existing thresholds"
    )
