        ...
        if path.suffix.lower() == ".json":
            ...
            with open(path, "rb") as f:
                ...
                return {
                    ...
                    "source_type": "binary",
                    "source_name": path.name,
                    "content_type": f"application/{path.suffix.lstrip('.')}" if path.suffix else "application/octet-stream",
                }
...
def main():
    ...
    parser.add_argument("--scan-only", action="store_true", help="Only scan, do not modify database")
    parser.add_argument("--force-reextract", action="store_true", help="Force re-extraction even if document exists")
