...
| `core/contracts/research_workspace.py` | Workspace/Session/Message、RuntimeProvider、受封闭 internal allowlist 与平台 registry 双重校验的 Skill、Agent Team/预算/日程、互斥来源 Note |
