...
2026-09-11 的格式基线维护仅整理既有本机集成与 Wind Python 文件，不新增、移动或重命名文件。
...
| `scripts/setup_web.py` | 项目专属 `.venv`、哈希锁、CJPY、私有 Corepack shim，以及 clone/checkout/status 共享 Windows long-path/symlink/换行语义的固定 DSH 跨平台安装器 |
