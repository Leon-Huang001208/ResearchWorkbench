# Research Workbench 资源监控页面 Implementation Plan

> **For agentic workers:** REQUIRED SUB-SKILL: Use superpowers:subagent-driven-development (recommended) or superpowers:executing-plans to implement this plan task-by-task. Steps use checkbox syntax for tracking.

**Goal:** 新增只监控当前 Research Workbench API 进程及递归子进程的实时资源监控页面，显示 CPU、内存、磁盘 I/O、网络连接数和进程归因。
...
| docs/modules/app_api.md、docs/modules/app_web.md、docs/FILE_GUIDE.md、docs/CHANGELOG.md、.ai/reports/2026-08-05-research-workbench-resource-monitor.md | 文档、变更记录和实际验证证据。 |
...
- [ ] **Step 5: 提交。**
    ...
    git commit -m "feat: collect Research Workbench process resources"
...
- Create: .ai/reports/2026-08-05-research-workbench-resource-monitor.md
...
- [ ] **Step 4: 提交文档和报告。**
    ...
    git add docs/modules/app_api.md docs/modules/app_web.md docs/FILE_GUIDE.md docs/CHANGELOG.md .ai/reports/2026-08-05-research-workbench-resource-monitor.md
...
- 不会使用整机网络字节数冒充 Research Workbench 数据；按进程网络字节数是明确非目标。
