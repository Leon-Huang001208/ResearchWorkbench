...
class FinancialReportAgent(BaseCognitiveAgent):
    """负责从财报证据中提取客观事实的 Agent。"""

    def __init__(self, model_gateway: ModelGateway):
        super().__init__(model_gateway, "financial_report_agent", "financial_report")
    ...
    def _build_prompt(self, context: AgentContext) -> str:
        return f"""你是一个专业的财报分析师，请基于以下信息进行客观分析，仅提取事实，避免主观判断。
