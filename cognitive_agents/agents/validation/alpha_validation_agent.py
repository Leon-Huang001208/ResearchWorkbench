...
class AlphaValidationAgent(BaseCognitiveAgent):
    """负责验证 Alpha 信号的 Agent。"""

    def __init__(self, model_gateway: ModelGateway):
        super().__init__(model_gateway, "alpha_validation_agent", "alpha_validation")
    ...
    def _build_prompt(self, context: AgentContext) -> str:
        return f"""你是一个专业的 Alpha 验证分析师，请基于以下信息，综合判断已有观点的有效性和可靠性。
