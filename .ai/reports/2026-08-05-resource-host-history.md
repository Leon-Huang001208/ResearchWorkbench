...
- 每个 UTC 分钟持久化最多一条 `host_capacity`，查询最多返回 1500 个按时间升序的安全公开点。
...
| 命令 | 实际结果 |
| --- | --- |
| `python -m pytest tests/unit/test_resource_host_history_service.py tests/unit/test_monitoring.py -q` | 47 passed |
