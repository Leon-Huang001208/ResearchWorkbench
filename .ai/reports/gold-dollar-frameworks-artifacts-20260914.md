...
- Full Research Web JavaScript suite after both live-render repairs: `281 passed, 1 skipped`.
...
- The same live pass found Dollar's 60-point SOFR-IORB series exceeding the F2 display contract. The renderer now plots the latest 30 observations while preserving all 60 points in the snapshot and score inputs; a live-shaped regression requires the F2 chart instead of its invalid-data fallback.
