# Test Report: RWB-AUTO-009 Architecture Review + Full Gate Cleanup

## Task ID

rwb-auto-009-architecture-review
...
- Local embedding config regression: PASS, local model directory is preferred, Hugging Face model ids are cache-only by default, and downloads require `RESEARCH_ALLOW_EMBEDDING_DOWNLOAD=1`.
