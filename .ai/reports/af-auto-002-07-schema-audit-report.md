# AF-AUTO-002-07: 数据库 Schema 审计与扩展报告
...
**设计要点**：
- ✅ 支持水位线持久化（AF-AUTO-002-03）
- ✅ 支持完整/增量模式切换
- ✅ 暂停控制（为 AF-AUTO-002-08 准备）
- ✅ 抓取统计聚合
...
| 表名 | 迁移文件 | 任务关联 |
|------|----------|----------|
| `pdf_artifact_v1` | 002 | AF-AUTO-002-05 |
| `pdf_conversion_v1` | 002 | AF-AUTO-002-06 |
| `crawl_state_v1` | 002 | AF-AUTO-002-03, -08 |
| `processed_item_v1` | 002 | AF-AUTO-002-03 |
...
1. **AF-AUTO-002-08**：基于 `crawl_state_v1` 和 `processed_item_v1` 构建监控和管理 API
