# Blocking Report: af-auto-011-00

## Current Task

- Task ID: af-auto-011-00
...
- Rerun every completion gate listed in `.ai/tasks/task_af_auto_011.json`.
...
- See `.ai/reports/test_report_af-auto-011-00.md` for the complete file and command record.
