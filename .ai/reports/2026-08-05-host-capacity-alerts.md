...
- 连续三个健康有效样本自动解决；缺失、`None`、布尔或其他非法主机字段不触发压力，也不会计入恢复。
...
| 命令 | 实际结果 |
| --- | --- |
| `python -m pytest tests/unit/test_resource_monitor_alert_service.py tests/unit/test_resource_monitor_runtime.py -q` | 20 passed |
