...
| 命令 | 实际结果 |
| --- | --- |
| `python -m pytest tests/unit/test_resource_monitor_alert_service.py tests/unit/test_resource_monitor_runtime.py tests/unit/data_layer/repositories/test_monitoring_repository.py -q` | 30 passed |
